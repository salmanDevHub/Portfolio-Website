...
const WhatIDo = () => {
  ...
  useEffect(() => {
    ...
    const handleCardClick = (event: Event) => {
      handleClick(event.currentTarget as HTMLDivElement);
    };
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build responsive, database-driven web applications with
                clean interfaces, secure authentication, and REST API
                integrations.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>MOBILE & AI</h3>
              <h4>Mobile apps and automation</h4>
              <p>
                I create user-friendly Flutter applications and explore AI
                automation and Python-based game logic to solve practical
                problems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
